<#
.SYNOPSIS
Reports on Entra ID devices in a detail view.

.DESCRIPTION
This script queries Microsoft Graph for devices and presents a detail report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraDeviceDetailReport.ps1
