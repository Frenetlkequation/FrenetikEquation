<#
.SYNOPSIS
Reports on AD LDAPS certificate.

.DESCRIPTION
This script gathers AD LDAPS certificate data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADDCLdapsCertificateReport.ps1
...
Write-Host "Retrieving domain controller LDAPS certificate report..." -ForegroundColor Cyan
