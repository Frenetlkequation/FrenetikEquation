<#
.SYNOPSIS
Reports on Entra ID service principals in a policy view.

.DESCRIPTION
This script queries Microsoft Graph for service principals and presents a policy report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraServicePrincipalPolicyReport.ps1
