<#
.SYNOPSIS
Reports on AD RDP security.

.DESCRIPTION
This script gathers AD RDP security data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADDCRdpSecurityReport.ps1
...
Write-Host "Retrieving domain controller RDP security report..." -ForegroundColor Cyan
