<#
.SYNOPSIS
Reports on AD Disk capacity.

.DESCRIPTION
This script gathers AD Disk capacity data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADDCDiskCapacityReport.ps1
...
Write-Host "Retrieving domain controller Disk capacity report..." -ForegroundColor Cyan
