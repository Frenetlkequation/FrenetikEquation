<#
.SYNOPSIS
Reports on AD Root hints.

.DESCRIPTION
This script gathers AD Root hints data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADDNSRootHintReport.ps1
...
Write-Host "Retrieving DNS Root hints report..." -ForegroundColor Cyan
