<#
.SYNOPSIS
Reports on Active Directory group description completeness.

.DESCRIPTION
This script highlights groups without useful descriptions to improve directory documentation quality.

.EXAMPLE
.[36mGet-ADGroupDescriptionCompletenessReport.ps1
...
$report = foreach ($group in $groups) {
    [PSCustomObject]@{
        ...
        DescriptionSet = [bool]$group.Description
    }
}
