<#
.SYNOPSIS
Reports on AD Orphaned records.

.DESCRIPTION
This script gathers AD Orphaned records data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADDNSOrphanedRecordReport.ps1
...
Write-Host "Retrieving DNS Orphaned records report..." -ForegroundColor Cyan
