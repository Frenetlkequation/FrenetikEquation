<#
.SYNOPSIS
Reports on AD SID filtering.

.DESCRIPTION
This script gathers AD SID filtering data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADTrustSIDFilteringReport.ps1
...
Write-Host "Retrieving AD trust SID filtering report..." -ForegroundColor Cyan
