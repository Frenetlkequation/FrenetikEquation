<#
.SYNOPSIS
Reports on AD Name servers.

.DESCRIPTION
This script gathers AD Name servers data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADDNSNameServerReport.ps1
...
Write-Host "Retrieving DNS Name servers report..." -ForegroundColor Cyan
