<#
.SYNOPSIS
Reports on AD Service status.

.DESCRIPTION
This script gathers AD Service status data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADDCServiceStatusReport.ps1
...
Write-Host "Retrieving domain controller Service status report..." -ForegroundColor Cyan
