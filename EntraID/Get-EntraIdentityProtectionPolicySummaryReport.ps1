<#
.SYNOPSIS
Reports on Entra ID risky users in a policy view.

.DESCRIPTION
This script queries Microsoft Graph for risky users and presents a policy report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraIdentityProtectionPolicySummaryReport.ps1
