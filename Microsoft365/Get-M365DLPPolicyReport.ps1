<#
.SYNOPSIS
Reports on Microsoft 365 DLP policies.

.DESCRIPTION
This script retrieves data loss prevention policies from Microsoft 365
compliance tools for governance review.
...
if ($report.Count -eq 0) {
    ...
    Write-Host "Retrieved $($report.Count) DLP policy(ies)." -ForegroundColor Green
