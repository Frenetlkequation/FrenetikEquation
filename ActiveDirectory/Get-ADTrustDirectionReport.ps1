<#
.SYNOPSIS
Reports on AD Direction.

.DESCRIPTION
This script gathers AD Direction data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADTrustDirectionReport.ps1
...
Write-Host "Retrieving AD trust Direction report..." -ForegroundColor Cyan
