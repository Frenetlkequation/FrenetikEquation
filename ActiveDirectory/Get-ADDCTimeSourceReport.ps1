<#
.SYNOPSIS
Reports on AD Time source.

.DESCRIPTION
This script gathers AD Time source data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADDCTimeSourceReport.ps1
...
Write-Host "Retrieving domain controller Time source report..." -ForegroundColor Cyan
