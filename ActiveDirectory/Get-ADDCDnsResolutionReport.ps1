<#
.SYNOPSIS
Reports on AD DNS resolution.

.DESCRIPTION
This script gathers AD DNS resolution data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADDCDnsResolutionReport.ps1
...
Write-Host "Retrieving domain controller DNS resolution report..." -ForegroundColor Cyan
