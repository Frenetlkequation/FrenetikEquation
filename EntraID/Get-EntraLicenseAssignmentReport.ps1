<#
.SYNOPSIS
Reports on Entra ID subscribed SKUs in a assignment view.

.DESCRIPTION
This script queries Microsoft Graph for subscribed SKUs and presents a assignment report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraLicenseAssignmentReport.ps1
