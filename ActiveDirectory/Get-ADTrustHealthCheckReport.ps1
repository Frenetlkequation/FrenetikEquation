<#
.SYNOPSIS
Reports on AD Health check.

.DESCRIPTION
This script gathers AD Health check data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADTrustHealthCheckReport.ps1
...
Write-Host "Retrieving AD trust Health check report..." -ForegroundColor Cyan
