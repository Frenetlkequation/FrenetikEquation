<#
.SYNOPSIS
Reports on Entra ID groups in a policy view.

.DESCRIPTION
This script queries Microsoft Graph for groups and presents a policy report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraGroupPolicyReport.ps1
