<#
.SYNOPSIS
Reports on Entra ID groups in a assignment view.

.DESCRIPTION
This script queries Microsoft Graph for groups and presents a assignment report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraGroupAssignmentReport.ps1
