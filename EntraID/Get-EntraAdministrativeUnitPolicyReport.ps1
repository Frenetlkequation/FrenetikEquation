<#
.SYNOPSIS
Reports on Entra ID administrative units in a policy view.

.DESCRIPTION
This script queries Microsoft Graph for administrative units and presents a policy report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraAdministrativeUnitPolicyReport.ps1
