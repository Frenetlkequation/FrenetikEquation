<#
.SYNOPSIS
Reports on Active Directory organizational unit delegated permissions.

.DESCRIPTION
This script inspects OU ACLs to show delegated permissions and access control entries.

.EXAMPLE
.[36mGet-ADOUDelegatedPermissionDetailReport.ps1
