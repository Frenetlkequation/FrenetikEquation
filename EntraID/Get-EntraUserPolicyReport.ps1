<#
.SYNOPSIS
Reports on Entra ID users in a policy view.

.DESCRIPTION
This script queries Microsoft Graph for users and presents a policy report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraUserPolicyReport.ps1
