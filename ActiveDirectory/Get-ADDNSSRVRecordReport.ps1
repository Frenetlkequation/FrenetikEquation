<#
.SYNOPSIS
Reports on AD SRV records.

.DESCRIPTION
This script gathers AD SRV records data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADDNSSRVRecordReport.ps1
...
Write-Host "Retrieving DNS SRV records report..." -ForegroundColor Cyan
