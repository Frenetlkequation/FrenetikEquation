<#
.SYNOPSIS
Reports on SharePoint Online site storage.

.DESCRIPTION
This script inventories site storage usage for capacity review.

.EXAMPLE
.\Get-SharePointSiteStorageGrowthReport.ps1
...
Write-Host "Retrieved $($report.Count) site storage record(s)." -ForegroundColor Green
