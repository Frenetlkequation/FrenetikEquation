<#
.SYNOPSIS
Reports on Entra ID subscribed SKUs in a policy view.

.DESCRIPTION
This script queries Microsoft Graph for subscribed SKUs and presents a policy report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraLicensePolicyReport.ps1
