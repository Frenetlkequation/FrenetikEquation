<#
.SYNOPSIS
Reports on AD Zone delegation.

.DESCRIPTION
This script gathers AD Zone delegation data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADDNSZoneDelegationReport.ps1
...
Write-Host "Retrieving DNS Zone delegation report..." -ForegroundColor Cyan
