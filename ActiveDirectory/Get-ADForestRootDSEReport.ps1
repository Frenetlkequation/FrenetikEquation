<#
.SYNOPSIS
Reports on Active Directory forest RootDSE data.

.DESCRIPTION
This script reads RootDSE attributes for documentation and troubleshooting.

.EXAMPLE
.\Get-ADForestRootDSEReport.ps1
...
Write-Host "Retrieving RootDSE data..." -ForegroundColor Cyan
...
$report = @([PSCustomObject]@{
    ...
    DomainControllerFunctionality = $root.domainControllerFunctionality
