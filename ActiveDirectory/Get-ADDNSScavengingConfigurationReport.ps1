<#
.SYNOPSIS
Reports on AD Scavenging configuration.

.DESCRIPTION
This script gathers AD Scavenging configuration data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADDNSScavengingConfigurationReport.ps1
...
Write-Host "Retrieving DNS Scavenging configuration report..." -ForegroundColor Cyan
...
try {
    ...
    $report = foreach ($zone in $zones) {
        [PSCustomObject]@{
            ReportType      = 'Scavenging configuration'
