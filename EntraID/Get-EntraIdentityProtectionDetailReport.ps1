<#
.SYNOPSIS
Reports on Entra ID risky users in a detail view.

.DESCRIPTION
This script queries Microsoft Graph for risky users and presents a detail report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraIdentityProtectionDetailReport.ps1
