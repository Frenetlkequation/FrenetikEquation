<#
.SYNOPSIS
Reports on Entra ID service principals in a assignment view.

.DESCRIPTION
This script queries Microsoft Graph for service principals and presents a assignment report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraServicePrincipalAssignmentReport.ps1
