<#
.SYNOPSIS
Reports on Active Directory service account SPNs.

.DESCRIPTION
This script lists service principal names assigned to managed service accounts for duplicate detection.

.EXAMPLE
.[36mGet-ADServiceAccountSPNReport.ps1
...
$accounts = Get-ADServiceAccount -Filter * -Properties ServicePrincipalName
