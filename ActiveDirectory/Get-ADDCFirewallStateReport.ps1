<#
.SYNOPSIS
Reports on AD Firewall state.

.DESCRIPTION
This script gathers AD Firewall state data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADDCFirewallStateReport.ps1
...
Write-Host "Retrieving domain controller Firewall state report..." -ForegroundColor Cyan
