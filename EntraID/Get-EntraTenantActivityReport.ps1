<#
.SYNOPSIS
Reports on Entra ID tenant organization details in a activity view.

.DESCRIPTION
This script queries Microsoft Graph for tenant organization details and presents a activity report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraTenantActivityReport.ps1
