<#
.SYNOPSIS
Reports on Entra ID tenant organization details in a policy view.

.DESCRIPTION
This script queries Microsoft Graph for tenant organization details and presents a policy report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraTenantPolicyReport.ps1
