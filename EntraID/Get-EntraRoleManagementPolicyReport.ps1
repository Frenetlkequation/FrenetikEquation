<#
.SYNOPSIS
Reports on Entra ID directory roles in a policy view.

.DESCRIPTION
This script queries Microsoft Graph for directory roles and presents a policy report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraRoleManagementPolicyReport.ps1
