<#
.SYNOPSIS
Reports on Entra ID devices in a assignment view.

.DESCRIPTION
This script queries Microsoft Graph for devices and presents a assignment report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraDeviceAssignmentReport.ps1
