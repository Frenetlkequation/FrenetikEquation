<#
.SYNOPSIS
Reports on Active Directory service account delegation settings.

.DESCRIPTION
This script inventories service accounts with delegation-related attributes for service hardening review.

.EXAMPLE
.[36mGet-ADServiceAccountDelegationReport.ps1
...
$accounts = Get-ADServiceAccount -Filter * -Properties TrustedForDelegation, AccountNotDelegated, ServicePrincipalName
