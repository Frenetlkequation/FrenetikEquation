<#
.SYNOPSIS
Reports on AD DFSR recovery.

.DESCRIPTION
This script gathers AD DFSR recovery data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADDCDfsrRecoveryReport.ps1
...
Write-Host "Retrieving domain controller DFSR recovery report..." -ForegroundColor Cyan
