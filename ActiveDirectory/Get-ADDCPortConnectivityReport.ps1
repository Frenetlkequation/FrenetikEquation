<#
.SYNOPSIS
Reports on AD Port connectivity.

.DESCRIPTION
This script gathers AD Port connectivity data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADDCPortConnectivityReport.ps1
...
Write-Host "Retrieving domain controller Port connectivity report..." -ForegroundColor Cyan
