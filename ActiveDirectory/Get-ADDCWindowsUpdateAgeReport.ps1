<#
.SYNOPSIS
Reports on AD Windows Update age.

.DESCRIPTION
This script gathers AD Windows Update age data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADDCWindowsUpdateAgeReport.ps1
...
Write-Host "Retrieving domain controller Windows Update age report..." -ForegroundColor Cyan
