<#
.SYNOPSIS
Reports on Entra ID users in a detail view.

.DESCRIPTION
This script queries Microsoft Graph for users and presents a detail report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraUserDetailReport.ps1
