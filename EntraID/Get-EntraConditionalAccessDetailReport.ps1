<#
.SYNOPSIS
Reports on Entra ID Conditional Access policies in a detail view.

.DESCRIPTION
This script queries Microsoft Graph for Conditional Access policies and presents a detail report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraConditionalAccessDetailReport.ps1
