<#
.SYNOPSIS
Reports on AD Transitivity.

.DESCRIPTION
This script gathers AD Transitivity data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADTrustTransitivityReport.ps1
...
Write-Host "Retrieving AD trust Transitivity report..." -ForegroundColor Cyan
