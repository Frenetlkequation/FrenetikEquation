<#
.SYNOPSIS
Reports on AD Record timestamps.

.DESCRIPTION
This script gathers AD Record timestamps data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADDNSRecordTimestampReport.ps1
...
Write-Host "Retrieving DNS Record timestamps report..." -ForegroundColor Cyan
