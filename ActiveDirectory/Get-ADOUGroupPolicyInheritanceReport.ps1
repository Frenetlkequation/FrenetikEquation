<#
.SYNOPSIS
Reports on Active Directory OU Group Policy inheritance.

.DESCRIPTION
This script reports GPO inheritance and block inheritance settings for organizational units.

.EXAMPLE
.[36mGet-ADOUGroupPolicyInheritanceReport.ps1
...
$report = foreach ($ou in $ous) {
    ...
    [PSCustomObject]@{
        ...
        GpoLinks          = @($inheritance.GpoLinks).Count
