<#
.SYNOPSIS
Reports on Entra ID Conditional Access policies in a policy view.

.DESCRIPTION
This script queries Microsoft Graph for Conditional Access policies and presents a policy report for governance, security, and operations review.
