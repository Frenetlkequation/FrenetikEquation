<#
.SYNOPSIS
Reports on AD TGT delegation.

.DESCRIPTION
This script gathers AD TGT delegation data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADTrustTGTDelegationReport.ps1
...
Write-Host "Retrieving AD trust TGT delegation report..." -ForegroundColor Cyan
