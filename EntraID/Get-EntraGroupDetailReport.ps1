<#
.SYNOPSIS
Reports on Entra ID groups in a detail view.

.DESCRIPTION
This script queries Microsoft Graph for groups and presents a detail report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraGroupDetailReport.ps1
