<#
.SYNOPSIS
Reports on Entra ID privileged role schedule instances in a policy view.

.DESCRIPTION
This script queries Microsoft Graph for privileged role schedule instances and presents a policy report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraPrivilegedIdentityManagementPolicyReport.ps1
