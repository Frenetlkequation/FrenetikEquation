<#
.SYNOPSIS
Reports on Entra ID privileged role schedule instances in a assignment view.

.DESCRIPTION
This script queries Microsoft Graph for privileged role schedule instances and presents a assignment report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraPrivilegedIdentityManagementAssignmentReport.ps1
