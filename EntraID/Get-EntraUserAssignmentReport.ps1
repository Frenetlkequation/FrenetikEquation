<#
.SYNOPSIS
Reports on Entra ID users in a assignment view.

.DESCRIPTION
This script queries Microsoft Graph for users and presents a assignment report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraUserAssignmentReport.ps1
