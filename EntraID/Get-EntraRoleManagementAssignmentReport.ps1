<#
.SYNOPSIS
Reports on Entra ID directory roles in a assignment view.

.DESCRIPTION
This script queries Microsoft Graph for directory roles and presents a assignment report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraRoleManagementAssignmentReport.ps1
