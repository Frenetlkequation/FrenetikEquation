<#
.SYNOPSIS
Reports on AD Zone aging.

.DESCRIPTION
This script gathers AD Zone aging data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADDNSZoneAgingReport.ps1
...
Write-Host "Retrieving DNS Zone aging report..." -ForegroundColor Cyan
