<#
.SYNOPSIS
Reports on Entra ID tenant organization details in a assignment view.

.DESCRIPTION
This script queries Microsoft Graph for tenant organization details and presents a assignment report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraTenantAssignmentReport.ps1
