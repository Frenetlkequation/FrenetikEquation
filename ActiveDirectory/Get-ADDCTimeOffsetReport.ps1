<#
.SYNOPSIS
Reports on AD Time offset.

.DESCRIPTION
This script gathers AD Time offset data and formats a PSCustomObject report for quick review.

.EXAMPLE
.\Get-ADDCTimeOffsetReport.ps1
...
Write-Host "Retrieving domain controller Time offset report..." -ForegroundColor Cyan
