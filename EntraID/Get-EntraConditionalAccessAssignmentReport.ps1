<#
.SYNOPSIS
Reports on Entra ID Conditional Access policies in a assignment view.

.DESCRIPTION
This script queries Microsoft Graph for Conditional Access policies and presents a assignment report for governance, security, and operations review.

.EXAMPLE
.\Get-EntraConditionalAccessAssignmentReport.ps1
