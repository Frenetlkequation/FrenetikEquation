<#
.SYNOPSIS
Reports on Active Directory domain trusts.

.DESCRIPTION
This script inventories trusts defined in the current domain and reports
on trust direction, type, and transitivity.
...
Write-Host "Retrieving domain trust information..." -ForegroundColor Cyan
